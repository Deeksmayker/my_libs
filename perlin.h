...
float stb_perlin_noise3_internal(float x, float y, float z, int x_wrap, int y_wrap, int z_wrap, unsigned char seed)
{
   ...
   n0 = stb__perlin_lerp(n00,n01,v) * 2;
   n1 = stb__perlin_lerp(n10,n11,v) * 2;

   return stb__perlin_lerp(n0,n1,u);
}

float perlin_noise3(float x, float y, float z, int x_wrap = 0, int y_wrap = 0, int z_wrap = 0)
{
    return stb_perlin_noise3_internal(x,y,z,x_wrap,y_wrap,z_wrap,0);
}

float perlin_noise3_seed(float x, float y, float z, int seed, int x_wrap = 0, int y_wrap = 0, int z_wrap = 0)
{
